...
public class share_picture_tab extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgView = view.findViewById(R.id.ImgShare);
        edtDescription = view.findViewById(R.id.edtImgDescr);
        btnShare = view.findViewById(R.id.btnShareImage);
        imgView.setOnClickListener(share_picture_tab.this);
        ...
        switch(view.getId()){
            ...
            case R.id.btnShareImage:
                if(receivedImageBitmap != null){
                    ...
                    FancyToast.makeText(getContext(),"Error: You must take an image",
                            Toast.LENGTH_SHORT,FancyToast.ERROR,true).show();
                }
        }
    }
